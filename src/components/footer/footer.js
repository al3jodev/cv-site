...
const Footer = ({ className }) => {
  ...
  return (
    <footer className={className}>
      ...
      <div>
        {github && <Link href={github} icon={FaGithub} arial-label="Github" />}
        {twitter && (
          <Link href={twitter} icon={FaTwitter} arial-label="Twitter" />
        )}
        {linkedin && (
          <Link href={linkedin} icon={FaLinkedin} arial-label="Linkedin" />
        )}
      </div>
    </footer>
  )
